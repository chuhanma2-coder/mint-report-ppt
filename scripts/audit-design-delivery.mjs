...
const reviewIssues=[...executiveReviewIssues(review,ir.slides.map(s=>s.id),ir.executionBrief?.decisionSystems),...designAcceptanceIssues(review,ir,read('.outline-measurements.json'))],issues=[...reviewIssues];
