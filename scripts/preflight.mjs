...
import {validateExecutionBrief,preflightPreview} from './lib/execution-brief.mjs';
...
const issues=validateExecutionBrief(brief,ledger);
console.log(JSON.stringify({...preflightPreview(brief),issues},null,2));
