...
try { const report = await auditPpt({ file, taskFile: task, sectionId: section, mode: "section", output: outputArg ? path.resolve(outputArg.slice(9)) : null }); console.log(JSON.stringify(report, null, 2)); if (!report.passed) process.exit(1); }
