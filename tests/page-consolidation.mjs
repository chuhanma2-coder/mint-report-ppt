...
assert.match(consolidationIssues(thinRich, theme).join(" "), /fewer than five visible modules/);
const adjacent = [
...
assert.match(consolidationIssues(adjacent, theme).join(" "), /adjacent low-density pages/);
